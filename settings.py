...
sources = {
    ...
    # "thirtysecondsofcode": [ # The hashed key can change
    #     f"https://www.30secondsofcode.org/_next/data/XtpTArwdSXwF-SbNbpEAE/blog/p/{random.randint(1, 8)}.json", # Get the recommended articles
    #     f"https://www.30secondsofcode.org/_next/data/XtpTArwdSXwF-SbNbpEAE/blog/n/{random.randint(1, 9)}.json", # Get the newest articles
    #     f"https://www.30secondsofcode.org/_next/data/XtpTArwdSXwF-SbNbpEAE/python/p/{random.randint(1, 11)}.json" # Get python latest news
    # ],
    "kitze": [
